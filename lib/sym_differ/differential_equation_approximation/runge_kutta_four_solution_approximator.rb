  ...
  module DifferentialEquationApproximation
    ...
    class RungeKuttaFourSolutionApproximator
      ...
      def calculate_next_value(evaluation_path, current_step)
        homogenized_y_function_value = homogenize_expression_value { extract_base_y_function_value(evaluation_path) }

        return :undefined if homogenized_y_function_value == :undefined
